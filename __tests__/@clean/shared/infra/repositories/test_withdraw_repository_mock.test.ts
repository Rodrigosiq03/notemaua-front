...
test('Test withdraw repository mock create withdraw', async () => {
    ...
    const withdraw = await repoWithdraw.createWithdraw('34103', '22.00680-0@maua.br')
...
test('Test notebook error to find', async () => {
    ...
    await expect(repo.finishWithdraw('34104')).rejects.toThrow('No items found for this withdraw numSerie: 34104');
