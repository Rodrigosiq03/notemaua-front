          ...
          <CardGray>
            <CardWhite>
                <ContainerCardContent>
                  ...
                  <Title style={{ paddingTop: '0px', marginBottom: '0px' }}>Redefinir Senha</Title>
                  <FormContainer onSubmit={handleSubmit(onSubmit)}>
                    <p style={{textAlign: 'center', fontSize: '20px'}}>Você receberá um e-mail<br/>para redefinir sua senha.</p>
