                ...
                <CardWhiteADM>
                    <FormContainer>
                        ...
                        <CardADM>
                            ...
                            <ContainerRowADM2>
                                <FormInput placeholder='Pesquisar' style={{marginLeft: '20px', width: '160px', height: '30px', marginBottom: '15px'}}></FormInput>
                                <FormSelect>
                                    <option>RA</option>
                                    <option>Número de série</option>
                                </FormSelect>
                                <FormButtonSearch type="submit"><SearchIcon/></FormButtonSearch>
                            </ContainerRowADM2>
                            ...
                            <hr style={{marginLeft: '20px', marginRight: '20px', borderColor: 'd6d6d6', marginTop: '0px'}}/>
                            <ListNumSerie>
