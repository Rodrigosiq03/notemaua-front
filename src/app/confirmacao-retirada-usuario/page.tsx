              ...
              <ContainerCardContent>
                ...
                <CheckCircleIcon style={{ fontSize: '140px', color: '#00b300', paddingTop: '5px' }} />
                    <div>
                        ...
                        <p style={{ textAlign: 'center', fontSize: '13px', margin: '0px' }}>Luigi Guimarães Trevisan</p>
                        <p style={{ textAlign: 'center', fontSize: '13px', margin: '0px' }}>22.01102-0@maua.br</p>
                        <p style={{ textAlign: 'center', fontSize: '13px', margin: '0px' }}>RA:<strong>22.01102-0</strong></p>
                    </div>
                <ContainerRow>
